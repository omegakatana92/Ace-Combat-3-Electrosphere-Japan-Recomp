...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/RetroPortingToolKit/AceCombat3ElectrosphereRecomp/total)](https://github.com/RetroPortingToolKit/AceCombat3ElectrosphereRecomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/RetroPortingToolKit/AceCombat3ElectrosphereRecomp/latest/total)](https://github.com/RetroPortingToolKit/AceCombat3ElectrosphereRecomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/RetroPortingToolKit/AceCombat3ElectrosphereRecomp)](https://github.com/RetroPortingToolKit/AceCombat3ElectrosphereRecomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Ace Combat 3: Electrosphere** built on
...
Zip prefix for CI artifacts: `acecombat3electrosphere`.
