...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Ace Combat 3: Electrosphere",
    .project_root_env = "ACECOMBAT3ELECTROSPHERERECOMP_PROJECT_ROOT",
    .build_dir_env = "ACECOMBAT3ELECTROSPHERERECOMP_BUILD_DIR",
    .force_setup_env = "ACECOMBAT3ELECTROSPHERERECOMP_FORCE_SETUP",
    ...
    .exe_basename = "Ace_Combat_3_Electrosphere_Recompiled",
    .prepare_note =
